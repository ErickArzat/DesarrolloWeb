...
export default{
    es:{
       ...
       planeacion:{
        ...
        services:{
            title: 'Servicios',
            title_ubication: 'Ubicación',
            title_decoration: 'Decoración',
            title_music: 'Musica',
            title_food: 'Comida',
            desc_ubication: 'Nosotros nos encargamos de proporcionar una ubicación ideal para tu evento',
            desc_decoration: 'Trabajamos en conjunto para poder encontrar la decoración adecuada para ti',
            desc_music: 'Con nuestro basto repertorio de artistas buscamos el que se adapte perfectamente al tono de tu evento',
            desc_food: 'Variedad de alimentos para cumplir con el paladar y necesidades de nuestros clientes'
        },
        carousel:{
